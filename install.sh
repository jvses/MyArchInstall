...
#sudo pacman -S --noconfirm lolcat cmatrix cowsay neofeth figlet xf86-video-intel xorg i3-gaps firefox rofi terminator dmenu terminator lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings htop bashtop feh lxappearance thunar nautilus pavucontrol file-roller mpv imv git vim midori discord arandr xorg-xrandr arduino evince gedit flatpak tlp clamav clamtk
...
# xinit-xsession teams ytfzf bottles drawio handbrake odisee i3lock-color polyba pdf-arranger picomjo o instalador de fontes projectlibre brave vscode telegram slack inkscape videodownloader spotify gotp 
